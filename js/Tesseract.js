...
const recognize = function (evt) {
    ...
    //Tesseract.jsの実行
    Tesseract
        .recognize(files[0], { lang: 'eng', tessedit_pageseg_mode: "PSM_SINGLE_LINE", tessedit_char_whitelist: '0123456789', tessedit_char_blacklist: "!?@#$%&*()<>_-+=/:;'\"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz" })
        .progress(function (p) {
            // 進歩状況の表示
            //進捗状況を表示するspanタグを指定
